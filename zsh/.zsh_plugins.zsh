fpath+=( "$HOME/Library/Caches/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-ajeetdsouza-SLASH-zoxide" )
source "$HOME/Library/Caches/antidote/https-COLON--SLASH--SLASH-github.com-SLASH-ajeetdsouza-SLASH-zoxide/zoxide.plugin.zsh"
